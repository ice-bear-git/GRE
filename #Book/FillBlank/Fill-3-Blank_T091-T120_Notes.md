...
* [The only `respite from` sensory deprivation of the sessions came from the handsome color sides favored by the corporate presenters.]():
...
* [foreground](): 突出的地方, 最显著的位置 // **强调;使突出**
* [circumvent](): 回避 
...
* 合作(corporation) 应该是属于 社会性(sociability)
